...
function SVGShape(file, spriter) {
	...
	this.align				=  Object.entries(_.extend({}, this.config.align['*'], (this.id in this.config.align) ? this.config.align[this.id] : ((relative in this.config.align) ? this.config.align[relative] : {})));
