 ...
 * @type {Object}
 */
SVGSpriteUniversal.prototype = Object.assign(Object.create(SVGSpriteStandalone.prototype), {
...
SVGSpriteUniversal.prototype._buildSVG = function(xmlDeclaration, doctypeDeclaration) {
    const rootAttributes = Object.assign(this.config.svg.dimensionAttributes ? {
    ...
    const svg = new SVGSprite(_xmlDeclaration, _doctypeDeclaration, rootAttributes, true);
