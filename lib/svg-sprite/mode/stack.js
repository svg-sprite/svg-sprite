 ...
 * @type {object}
 */
SVGSpriteStack.prototype = Object.assign(
  Object.create(SVGSpriteStandalone.prototype),
  {
...
SVGSpriteStack.prototype._init = function () {
  ...
  for (const shape of this.data.shapes) {
    this.maxDimensions.width = Math.max(
      this.maxDimensions.width,
      shape.width.outer
    );
    this.maxDimensions.height = Math.max(
 ...
 */
SVGSpriteStack.prototype._buildSVG = function (
  xmlDeclaration,
  doctypeDeclaration
) {
