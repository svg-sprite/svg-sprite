 ...
 * @type {object}
 */
SVGSpriteSymbol.prototype = Object.assign(
 ...
 */
SVGSpriteSymbol.prototype._buildSVG = function (
  xmlDeclaration,
  doctypeDeclaration
) {
  ...
  const rootAttributes = inline
    ...
    : defaultRootAttributes;
  const _xmlDeclaration = inline
    ? ''
    : this.declaration(this.config.svg.xmlDeclaration, xmlDeclaration);
  const _doctypeDeclaration = inline
    ? ''
