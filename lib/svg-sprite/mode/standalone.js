 ...
 * @type {object}
 */
SVGSpriteStandalone.prototype = Object.assign(
  Object.create(SVGSpriteBase.prototype),
  {
...
SVGSpriteStandalone.prototype._init = function () {
  ...
  this.config.dimensions = isString(this.config.dimensions)
    ? this.config.dimensions.trim()
    : '-dims';
