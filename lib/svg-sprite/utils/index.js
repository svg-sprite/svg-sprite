...
/**
 * Checks if value is the language type of Object (e.g. objects, regexes, new
 * Number(0), and new String('')). Excluding arrays (new Array())
 *
 * @param   {any}     value The value to check.
 *
 ...
 * @param   {any}     value The value to check.
 *
 * @returns {boolean}       Returns true if value is an plain object, else
 *   false.
 */
