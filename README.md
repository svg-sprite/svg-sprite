...
On a personal note: This is my first ever Node.js module, so please be forgiving in case of errors (and please drop me a line instead of dropping the module altogether  — I'd really appreciate that). Currently I'm working on a Node.js / Grunt / Gulp port of my PHP based [iconizr project](https://github.com/jkphl/iconizr), with *svg-sprite* being the base of it. That said, you will find most of the configuration options to be identical with those of *iconizr*.
